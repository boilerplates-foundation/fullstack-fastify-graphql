...
module.exports = model => {
	 ...
	 * @property {sequelize.WhereOptions} where - The query applied to findAll call
	 * @property {sequelize.FindOptionsAttributesArray} attributes=[] - The query applied to findAll and select only some attributes
	 * @property {sequelize.IncludeOptions} include=[] - Applied to findAll for eager loading
	 * @property {number} limit - Limit the number of records returned <b style="color:red">(required)</b>
	 * @property {sequelize.FindOptionsOrderArray} order=[] - custom ordering attributes,
